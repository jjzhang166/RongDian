...
ASSOC_BEGIN()
	...
	ASSOC_LANG(MSG_INFORMATION, kMsgInformation, LS_MSG)
	...
	ASSOC_LANG(MSG_UPDATE_FAIL, kUpdateFail, LS_MSG)
	ASSOC_LANG(MSG_UPDATE_SUCCESS, kUpdateSuccess, LS_MSG)
	ASSOC_LANG(MSG_EXISTED_NAME, kExistedName, LS_MSG)
	ASSOC_LANG(MSG_INVALID_NAME, kInvalidName, LS_MSG)
	ASSOC_LANG(MSG_DEBUG_TEXT, kDebugText, LS_MSG)
	ASSOC_LANG(MSG_OPT_SUCCESS, kOperationSuccess, LS_MSG)
	ASSOC_LANG(MSG_NEW_VERSION, kNewVersion, LS_MSG)
ASSOC_END()
