...
ASSOC_BEGIN()
	...
	ASSOC_LANG(MSG_FAILED, kMsgFailed, LS_MSG)
	...
	ASSOC_LANG(MSG_DOMAIN_ERR, kInvalidDomainErr, LS_MSG)
	...
	ASSOC_LANG(MSG_REPLACE_FILES, kReplaceFiles, LS_MSG)
	ASSOC_LANG(MSG_BACKEDUP_TO, kBackedupTo, LS_MSG)
ASSOC_END()
