...
void WindowImplBase::ReleaseRes()
{
...
LRESULT WindowImplBase::OnMouseActivate(UINT /*uMsg*/, WPARAM wParam, LPARAM /*lParam*/, BOOL& bHandled)
{
	bHandled = FALSE;
	return 0;
}

LRESULT WindowImplBase::OnActivate(UINT /*uMsg*/, WPARAM wParam, LPARAM /*lParam*/, BOOL& bHandled)
{
	bHandled = FALSE;
	return 0;
}
...
LRESULT WindowImplBase::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_MOUSEACTIVATE:
		...
		break;
	case WM_ACTIVATE:
		lRes = OnActivate(uMsg, wParam, lParam, bHandled);
		break;
	case WM_TIMER:
